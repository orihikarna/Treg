...
/**
 * @class   vtkImageEuclideanDistance2
 * @brief   computes 3D Euclidean DT
 *
 * vtkImageEuclideanDistance2 implements the Euclidean DT using
 ...
 * vtkImageEuclideanDistance2::SetAlgorithmToSaitoCached() instead for better
 * performance.
 *
 * References:
 *
...
#ifndef vtkImageEuclideanDistance2_h
#define vtkImageEuclideanDistance2_h
...
class VTKIMAGINGGENERAL_EXPORT vtkImageEuclideanDistance2 : public vtkImageDecomposeFilter {
 public:
  static vtkImageEuclideanDistance2* New();
  vtkTypeMacro(vtkImageEuclideanDistance2, vtkImageDecomposeFilter);
   ...
   */
  vtkSetMacro(MaximumDistance, DistType);
  vtkGetMacro(MaximumDistance, DistType);
  ///@}
 ...
 protected:
  vtkImageEuclideanDistance2();
  ~vtkImageEuclideanDistance2() override = default;

  DistType MaximumDistance;
 ...
 private:
  vtkImageEuclideanDistance2(const vtkImageEuclideanDistance2&) = delete;
  void operator=(const vtkImageEuclideanDistance2&) = delete;
};
